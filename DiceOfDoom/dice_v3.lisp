...
; extra function to write the board to a svg file
(defun make-board-svg-file ()
...
;todo: implement multisession (pg 410)
;todo: also on pg 410 he says you could run arbitrary code (check this out)
...
(defun web-handle-computer ()
  ...
  (tag script ()
       (princ "window.setTimeout('window.location=\"game.html?chosen=NIL\"',3000)")))
